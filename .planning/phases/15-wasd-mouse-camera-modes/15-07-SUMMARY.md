...
provides:
  - AnalogMode enum in aethermap-common for IPC use
  - CameraOutputMode enum in aethermap-common for IPC use
...
key-files:
  created: []
  modified:
  - aethermap/aethermap-common/src/lib.rs (AnalogMode, CameraOutputMode)
  - aethermap/aethermap-gui/src/gui.rs (mode selector UI, message handlers)

key-decisions:
  - "Mirror enums in common rather than re-export from aethermapd (avoid circular dependencies)"
...
- Added AnalogMode enum to aethermap-common with 6 variants (Disabled, Dpad, Gamepad, WASD, Mouse, Camera)
- Added CameraOutputMode enum to aethermap-common with 2 variants (Scroll, Keys)
...
1. **Task 1: Add AnalogMode and CameraOutputMode to aethermap-common** - `f21f947` (feat)
...
- `aethermap/aethermap-common/src/lib.rs` - Added AnalogMode and CameraOutputMode enums with Display, Default, ALL constant
- `aethermap/aethermap-gui/src/gui.rs` - Added mode selector UI, message handlers, AnalogCalibrationView fields

## Decisions Made

- Mirror enums in aethermap-common rather than re-exporting from aethermapd (common is lower-level crate, avoiding circular dependency)
